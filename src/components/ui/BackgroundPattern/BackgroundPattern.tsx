...
const BackgroundPattern: FC<BackgroundPatternProps> = ({ rarity, className, ...props }) => {
  switch (rarity) {
    case 'common':
      return <Common className={cn(styles.background, styles.divine, className)} {...props} />;

    case 'rare':
      return <Rare className={cn(styles.background, styles.divine, className)} {...props} />;

    case 'epic':
      return <Epic className={cn(styles.background, styles.divine, className)} {...props} />;

    case 'mythic':
      return <Mythic className={cn(styles.background, styles.divine, className)} {...props} />;

    case 'legendary':
      return <Legendary className={cn(styles.background, styles.divine, className)} {...props} />;

    case 'divine':
      return <Divine className={cn(styles.background, styles.divine, className)} {...props} />;

    case 'tickets':
      return <Tickets className={cn(styles.background, styles.divine, className)} {...props} />;

    case 'ton':
      return <Ton className={cn(styles.background, styles.ton, className)} {...props} />;
