  ...
  return (
    <>
      <div className={styles.head}>
        ...
        <h1 className={styles.title}>{title || t('gift.modal.title')}</h1>
        <p className={styles.text}>{text || (isDirect ? t('gift.modal.direct_text') : t('gift.modal.template_text'))}</p>
      </div>

      <div className={styles.body}>
        <div className={styles.buttonsRow}>
          <Button className={cn(styles.button, styles.confirm)} onClick={() => onSelect('telegram')}>
