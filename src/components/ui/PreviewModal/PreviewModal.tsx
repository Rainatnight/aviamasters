...
export const PreviewModal: FC = () => {
        ...
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <div className={styles.info_block}>
              <h3>
                {t('banner.title')}
                <span className={styles.radial_text}> {t('banner.channel')}</span>
              </h3>
              <p className={styles.info_text}>{t('banner.text')}</p>
              <div className={styles.button_container}>
                <Button className={styles.button} primary onClick={handleClick}>
                  {t('banner.subscribe')}
                </Button>
              </div>
            </div>
  ...
  if (!isShowPreviewModal || !infoData) return null;
};
