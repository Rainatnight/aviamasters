...
const GiftCard: FC<GiftCardProps> = ({ size = 'small', rarity, autoplay = false, className, gift, model, value, options, lottie, file_url, ...props }) => {
  ...
  return (
    <div className={cn(styles.card, styles[rarityLowered], className)} style={{ border: `1px solid var(--color-rarity-${rarityLowered}-40)` }} {...props}>
      <div className={styles.content}>
        ...
        {(size === 'large' || size === 'xl') && (
          <div className={styles.price} style={{ backgroundColor: `var(--color-rarity-${rarityLowered}-25)` }}>
            {value ? (
              <>
