...
function GiftDeposit() {
  ...
  return (
    <motion.div initial='initial' animate='enter' variants={variants} transition={transition}>
      <Container className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.description}>{t('donate.withGift.description')}</p>
        </div>

        <div className={styles.list}>
          {isGiftsSuccess &&
            giftsData?.gifts?.map((gift, index) => (
              <div key={index + gift.model} className={styles.link}>
                <GiftCard
                  size='large'
        ...
        <div className={styles.buttons}>
          <div className={styles.wrapper}>
            <Button className={styles.button} onClick={() => dispatch(open())} primary>
              {t('donate.deposit')}
            </Button>
            {isOpen && (
              <div ref={popupRef} className={styles.popup}>
                ...
                <p className={styles.text}>
                  ...
                  <span className={styles.link} onClick={() => webApp.openTelegramLink('https://t.me/chancegifts')}>
                    @chancegifts
                  </span>
                </p>
              </div>
