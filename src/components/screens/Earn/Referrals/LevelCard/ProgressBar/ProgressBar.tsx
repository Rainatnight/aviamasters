    ...
    <div className={styles.volumeBar}>
      ...
      <div className={styles.labels}>
        ...
        <span className={styles.center}>
          {t(`earn.referrals.invite.${label}`)} {formatNumber(value)}{' '}
          <span className={styles.icon}>{label === 'volume' ? <IconTon width={14} height={14} /> : <IconReferrals width={12} height={12} />}</span>
        </span>
