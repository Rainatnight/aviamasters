  ...
  return (
    <div className={styles.card}>
      <div className={styles.level}>
        <span>
          {t('earn.referrals.invite.level')} {level}
        </span>
        {!isActive && <IconLock />}
      </div>
      ...
      <div className={styles.info}>
        ...
        <span>{t('earn.referrals.invite.percent.text.start')}</span>
        <span className={styles.rate}>{percentage}%</span>
      ...
      {isExclusive && (
        <div className={`${styles.badge} ${styles[`badge--${color}`]}`}>
          <span>{t('earn.referrals.invite.exclusive')}</span>
        </div>
      )}
