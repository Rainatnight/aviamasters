...
const Invite: FC = () => {
  ...
  useLayoutEffect(() => {
    if (!emblaApi || !sortedLevelsData.length || !infoData?.referral_level || isInfoLoading) return;
    ...
    <section className={styles.invite}>
      <Container>
        <div className={styles.inner}>
          ...
          <Button className={styles.button} onClick={handleButtonClick} primary>
            {t('earn.referrals.invite.button')}
          </Button>
        </div>
      </Container>
    </section>
